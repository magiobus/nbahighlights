          ...
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div className="pt-5 pb-6 px-5 sm:pb-8 bg-happy-pink">
              <div className="flex items-center justify-between">
                <div>
                  <Link href="/">
                    <a className="font-bold"> NBAHighlighs.fun 🏀</a>
                  </Link>
                </div>
                <div className="-mr-2">
            ...
            <div className="py-6 px-5 bg-happy-pink-600">
              <div className="grid grid-cols-1 gap-4 gap-y-8">
                ...
                {session ? null : (
                  <Link href="/auth/signin">
                    <a>
                      <button className="w-full text-normal font-semibold bg-buttonbg  text-buttontxt px-2 py-1 rounded-md  ">
                        Sign In
                      </button>
                    </a>
                  </Link>
    ...
    <div className="flex items-center md:ml-12">
      {session ? (
        <Menu as="div" className="ml-3 relative">
          ...
          >
            <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md  py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-40">
              <Menu.Item>
                {({ active }) => (
